...
namespace GestionAcademica.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstudianteId,Nombre,Apellido,Email,Codigo")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudianteId,Nombre,Apellido,Email, Codigo")] Estudiante estudiante)
        {
